...
<body>
    ...
    <div class="mil-wrapper">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mil-404-text">
                            <p class="mil-light-soft mil-mb-30">The page you are looking for does not exist; it may have
                                been moved or removed altogether.</p>
                            <a href="{{route('/')}}" class="mil-button mil-border mil-light"><span>Back to
                                    homepage</span></a>
                        </div>
        ...
        <div class="mil-addition-bottom">
            <div class="container-fluid">
                <p class="mil-text-sm mil-light-soft">© Codexer, trading as Reliance International London Limited
                    {{ date('Y') }}</p>

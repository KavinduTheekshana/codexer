       ...
       <footer class="mil-dark-bg">
            ...
            <div class="mil-footer-content">
                <div class="row align-items-center mil-p-120-60">
                    <div class="col-xl-6 mil-mb-60">
                        ...
                        <h3 class="mil-light mil-mb-15">Join The <span class="mil-accent">Codexer</span> Experience</h3>

                        <p class="mil-light-soft">Get the latest updates and innovations straight to your inbox. Subscribe now!</p>
                ...
                <div class="row justify-content-between mil-p-120-60">
                    <div class="col-md-3 col-lg-3 col-xl-3 mil-mb-30">
                        ...
                        <p class="mil-light mil-light-soft" style="margin-bottom: 45px">24 Colston Rise, Ampthill, <br>
                            Bedford, England MK45 2GN</p>

                        <ul class="mil-simple-list mil-mb-15">
                            <li class="mil-light"><span class="mil-accent">+44</span>&nbsp;<span class="mil-light-soft">20 313 78 313</span></li>
                            <li><span class="mil-accent">info</span><span class="mil-light mil-light-soft">@codexer.com</span></li>
                        </ul>
        ...
        <div class="mil-footer-bottom">
            <div class="container">
                <p class="mil-text-sm mil-light">© Codexer, trading as Reliance International London Limited  {{ date('Y') }}</p>

          ...
          <a href="{{route('testimonials.list')}}" class="{{ Request::segment(1) === 'testimonial' ? 'active-page' : null }}">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="star-rating.html"><i class="ri-circle-fill circle-icon text-indigo w-auto"></i> Star
                            Ratings</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="image-upload.html"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                            Upload</a>
                    </li>
                </ul>
            </li>
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="form-layout.html"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>
                            Input Layout</a>
                    </li>
                    <li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="table-basic.html"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                            Basic Table</a>
                    </li>
                    <li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="sign-in.html"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Sign
                            In</a>
                    </li>
                    <li>
